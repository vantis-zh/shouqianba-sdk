...
import com.vantisspace.sdk.shouqianba.litepos.bean.*;
import com.vantisspace.sdk.shouqianba.litepos.bean.callback.CardIssueCallback;
import com.vantisspace.sdk.shouqianba.litepos.bean.callback.SQBPayCallback;
...
import static com.vantisspace.sdk.shouqianba.litepos.common.client.SQBLitePosClient.GSON;

@Slf4j
public class SQBLitePosClientTest {
    private static final SQBLitePosClient shouQianBaClient;

    static {
        shouQianBaClient = new SQBLitePosClient(
                "",
                "",
                "",
    ...
    public void testActivate() {
        ...
        SQBLitePosResponse<WalletActivateResponseData> response = shouQianBaClient.call(request);
    ...
    public void testTopUp() {
        ...
        request.setClient_member_id("");
        SQBLitePosResponse<WalletTopUpResponseData> response = shouQianBaClient.call(request);
        log.info("回调解析: {}", GSON.toJson(response));
    }
    ...
    public void testAliPay() {
        ...
        request.setScene("10");
        request.setSales_time(new SimpleDateFormat(SQBLitePosClient.DATE_FORMAT).format(new Date()));
        ...
        SQBLitePosResponse<SQBAliPayResponseData> sqbAliPayResponse = shouQianBaClient.aliPay(request);
...
//        request.setReturn_url("");
        ...
        SQBLitePosResponse<SQBWeixinPayResponseData> response = shouQianBaClient.weixinPay(request);
        log.info("订单号: " + request.getRequest_id());
    }
    ...
    public void testQuery() {
        ...
        request.setWorkstation_sn("0");
        request.setCheck_sn("");
        SQBLitePosResponse<SQBSalesQueryResponseData> sqbLitePosResponse = shouQianBaClient.query(request);
        log.info(new Gson().toJson(sqbLitePosResponse));
        String status = Optional.ofNullable(sqbLitePosResponse)
                .map(SQBLitePosResponse::getResponse)
                .map(SQBLitePosResponse.Response::getBody)
                .map(SQBLitePosResponse.Body::getBiz_response)
                .map(SQBLitePosResponse.BodyData::getData)
    ...
    public void cancelPay() {
        ...
        SQBLitePosResponse<SQBVoidPayResponseData> sqbLitePosResponse = shouQianBaClient.voidPay(request);
        log.info(new Gson().toJson(sqbLitePosResponse));
        String storeSn = Optional.ofNullable(sqbLitePosResponse)
                .map(SQBLitePosResponse::getResponse)
                .map(SQBLitePosResponse.Response::getBody)
                .map(SQBLitePosResponse.Body::getBiz_response)
                .map(SQBLitePosResponse.BodyData::getData)
...
//        request.setDescription();
        ...
        tender.setCreate_time(new SimpleDateFormat(SQBLitePosClient.DATE_FORMAT).format(new Date()));
        tender.setOriginal_tender_sn(tenderSn);
        request.setTenders(Collections.singletonList(tender));
        SQBLitePosResponse<SQBRefundResponseData> refund = shouQianBaClient.refund(request);
    ...
    public void testCardQuery() {
        ...
        SQBLitePosResponse<CardsResponseData> response = shouQianBaClient.call(requestData);
    ...
    public void testCardRedeem() {
        ...
        SQBLitePosResponse<CardRedeemResponseData> response = shouQianBaClient.call(requestData);
        log.info(GSON.toJson(response));
    }
    ...
    public void testCardRedeemRecordsQuery() {
        ...
        SQBLitePosResponse<CardUsedResponseData> response = shouQianBaClient.call(requestData);
        log.info(GSON.toJson(response));
    }
    ...
    public void testCardRefund() {
        ...
        SQBLitePosResponse<CardRefundResponseData> response = shouQianBaClient.call(requestData);
        log.info(GSON.toJson(response));
    }
    ...
    public void testCardRefundQuery() {
        ...
        requestData.setOut_trade_no("");
        requestData.setOut_request_no(UUID.fastUUID().toString(true));
        SQBLitePosResponse<CardRefundQueryResponseData> response = shouQianBaClient.call(requestData);
        log.info(GSON.toJson(response));
    }
    ...
    public void testWebhook() throws ParseException {
        String json = "";
        SQBLitePosRequest<SQBPayCallback> request = shouQianBaClient.decodeCallback(json, SignAlgorithm.SHA1withRSA.getValue(), false);
        log.info("回调解析: {}", GSON.toJson(request));
        log.info("回调中的支付时间: {}", new SimpleDateFormat(SQBLitePosClient.DATE_FORMAT)
